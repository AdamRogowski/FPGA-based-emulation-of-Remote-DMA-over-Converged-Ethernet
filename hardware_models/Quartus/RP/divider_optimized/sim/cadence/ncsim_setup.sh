...
TOP_LEVEL_NAME="divider_optimized"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="C:/intelfpga_standard/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/divider_optimized_lpm_divide_201/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../lpm_divide_201/sim/divider_optimized_lpm_divide_201_ruc2ypa.vhd" -work divider_optimized_lpm_divide_201 -cdslib ./cds_libs/divider_optimized_lpm_divide_201.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/divider_optimized.vhd"                                                                                                                                                
fi
