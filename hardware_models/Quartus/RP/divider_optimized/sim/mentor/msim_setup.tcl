...
# ----------------------------------------
# If divider_optimized is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2025.07.02.13:23:20
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "divider_optimized"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/intelfpga_standard/quartus/"
}
...
ensure_lib                                  ./libraries/divider_optimized_lpm_divide_201/
vmap       divider_optimized_lpm_divide_201 ./libraries/divider_optimized_lpm_divide_201/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../lpm_divide_201/sim/divider_optimized_lpm_divide_201_ruc2ypa.vhd" -work divider_optimized_lpm_divide_201
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/divider_optimized.vhd"                                                                                    
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L divider_optimized_lpm_divide_201 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L divider_optimized_lpm_divide_201 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
